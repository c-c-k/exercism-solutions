...
def bake_time_remaining(elapsed_bake_time: int) -> int:
    ...
    Function that takes the actual minutes the lasagna has been
    in the oven as an argument and returns how many minutes the
...
def preparation_time_in_minutes(number_of_layers: int) -> int:
    ...
    :param number_of_layers: number of layers the lasagna has.
    :return: preparation time (in minutes) derived from ''PREPARATION_TIME.

    Function that takes the number of layers the lasagna needs
    to have and returns how many minutes it would take to
    prepare it based on 'PREPARATION_TIME'.
    """
